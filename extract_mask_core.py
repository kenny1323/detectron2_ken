...
class VisualizationDemo(object):
    ...
    def run_on_image(self, image, path):
        ...
        print('classes:', predictions['instances'].pred_classes.tolist())
        ...
        while i<len(instances_classes)-1:
            ...
            array_instance_scores=instances.scores.numpy()
            if instances_classes[i]==0 and array_instance_scores[i] > 0.6:
                print('class: ', instances_classes[i])
                print('score: ', array_instance_scores[i])
                mask_current=instances.pred_masks[i]
                #print(mask_current)
                y=-1
                x=-1
